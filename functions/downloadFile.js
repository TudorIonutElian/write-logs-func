...
const downloadFileFromS3 = async (fileKey) => {
    ...
    try {
        ...
        VALUES ('${fullObjectWrite.requestUrl}','${fullObjectWrite.requestUrl}','10.2.23.36','${fullObjectWrite.requestVpc},'${fullObjectWrite.requestRegion},'${fullObjectWrite.requestAvailabilityZone}','${fullObjectWrite.requestIamRole}','${fullObjectWrite.requestApiKey}',
